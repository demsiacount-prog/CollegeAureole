...
def creer_depense(payload: schemas.DepenseCreate, db: Session = Depends(get_db)):
    # La saisie (création comme correction) reste toujours permise : dépenses
    # et charges ne sont pas liées à une inscription, on peut les saisir ou les
    # corriger même sur une année clôturée.
