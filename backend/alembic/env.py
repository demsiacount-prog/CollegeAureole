...
if config.config_file_name is not None:
    # disable_existing_loggers=False : sans cela, la migration au démarrage
    # via fileConfig() neutralisait uvicorn.error / uvicorn.access (access log
    # et « Application startup complete » disparaissaient du terminal).
